...
const generateProfile = (data) => {
    let links = data.links.map(entry => {
        return <div className="col p-1" style={{display: "inline"}}><a href={entry.url} ><img src={entry.icon} width="25pt" height="25pt" /></a></div>
    })
    return (
        <>
            <div className="container-fluid primary-bg radius-sm d-none d-md-block">
                <div className="row p-5">
                    <div className="col-auto"><img className="rounded-circle" src={data.icon} width="250pt" height="250pt" /></div>
            ...
            <div className="container-fluid primary-bg radius-sm d-block d-md-none">
                <div className="row p-3">
                    <div className="col center-div"><img className="rounded-circle" src={data.icon} width="100pt" height="100pt" /></div>
                </div>
                <div className="row p-3">
